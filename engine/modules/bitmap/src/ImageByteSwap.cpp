...
//--[ This file was patched to make all ifdef _LINUX checks also check for windows, effectively removing all problematic,
//--[ Seemingly console only code.
...
//-----------------------------------------------------------------------------
    void
    PreConvertSwapImageData(unsigned char *pImageData, int nImageSize, ImageFormat imageFormat, int width, int stride) {
...
//-----------------------------------------------------------------------------
    void PostConvertSwapImageData(unsigned char *pImageData, int nImageSize, ImageFormat imageFormat, int width,
                                  int stride) {
        Assert(IsFormatValidForConversion(imageFormat));
