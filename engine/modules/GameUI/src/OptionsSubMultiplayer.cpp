...
void COptionsSubMultiplayer::RedrawAdvCrosshairImage()
{
	...
	r = seclamp( m_pAdvCrosshairRedSlider->GetSliderValue(), 0, 255 );
	g = seclamp( m_pAdvCrosshairGreenSlider->GetSliderValue(), 0, 255 );
	b = seclamp( m_pAdvCrosshairBlueSlider->GetSliderValue(), 0, 255 );
