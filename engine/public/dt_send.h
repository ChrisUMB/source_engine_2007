...
#define SENDINFO(varName)					#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName)
#define SENDINFO_ARRAY(varName)				#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName[0])
#define SENDINFO_ARRAY3(varName)			#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName[0]), sizeof(((currentSendDTClass*)0)->varName)/sizeof(((currentSendDTClass*)0)->varName[0])
#define SENDINFO_ARRAYELEM(varName, i)		#varName "[" #i "]", ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName[i]))), sizeof(((currentSendDTClass*)0)->varName[0])
#define SENDINFO_NETWORKARRAYELEM(varName, i)#varName "[" #i "]", ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName.m_Value[i]))), sizeof(((currentSendDTClass*)0)->varName.m_Value[0])
...
#define SENDINFO_VECTORELEM(varName, i)		#varName "[" #i "]", -(int)((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass::MakeANetworkVar_##varName*)0)->varName.m_Value[i]))), sizeof(((currentSendDTClass*)0)->varName.m_Value[0])
//                                            ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName)))
#define SENDINFO_STRUCTELEM(varName)		#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName.m_Value)
#define SENDINFO_STRUCTARRAYELEM(varName, i)#varName "[" #i "]", ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName.m_Value[i]))), sizeof(((currentSendDTClass*)0)->varName.m_Value[0])

// Use this when you're not using a CNetworkVar to represent the data you're sending.
#define SENDINFO_NOCHECK(varName)						#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName)
#define SENDINFO_STRING_NOCHECK(varName)				#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName)))
#define SENDINFO_DT(varName)							#varName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName)))
#define SENDINFO_DT_NAME(varName, remoteVarName)		#remoteVarName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName)))
#define SENDINFO_NAME(varName,remoteVarName)			#remoteVarName, ((::size_t)&reinterpret_cast<char const volatile&>((((currentSendDTClass*)0)->varName))), sizeof(((currentSendDTClass*)0)->varName)
