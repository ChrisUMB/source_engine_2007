...
#define XM_GET_DISABLEFOCUSRECURSION 2054
...
static __declspec(noinline) void XuiNotifyComboBoxListOpening(XUIMessage *pMsg, XUINotify* pNotify, XUINotifyComboBoxListOpening* pnmData, HXUIOBJ hObjSource, float fX, float fY, float fWidth, float fHeight)
{
