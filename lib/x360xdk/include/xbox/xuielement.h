...
#ifndef __XUIELEMENT_H__
#define __XUIELEMENT_H__
...
HRESULT APIENTRY XuiVideoSetPlayer(HXUIOBJ hObj, IXMediaXmvPlayer* pPlayer);
...
LRESULT XuiProcessImeMessage(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
#endif
