...
#if !defined (_XBOX_CRT_DEPRECATE_INSECURE) && !defined (_CRT_SECURE_NO_WARNINGS)
#define _CRT_SECURE_NO_WARNINGS
#endif
...
#if !defined (_XBOX_CRT_DEPRECATE_OBSOLETE) && !defined (_CRT_OBSOLETE_NO_DEPRECATE)
...
#define _XBOX_CRT_UNSUPPORTED(fn) _CRT_DEPRECATE_TEXT(#fn "() is not supported on Xbox.")
#define _XBOX_CRT_UNSUPPORTED_INSECURE(fn, _Replacement) _XBOX_CRT_UNSUPPORTED(fn)
#define _XBOX_CRT_UNSUPPORTED_NONSTDC(fn, _Replacement) _XBOX_CRT_UNSUPPORTED(fn)
#define _XBOX_CRT_UNSUPPORTED_NONSTDC_INSECURE(fn, _StdReplacement, _SecureReplacement) _XBOX_CRT_UNSUPPORTED(fn)

#if defined (NDEBUG) && !defined (_XBSTRICT)
#define _XBSTRICT
#endif
...
#if !defined (_XBOX_CRT_DEPRECATE_NONSTDC) && !defined (_CRT_NONSTDC_NO_WARNINGS)
#define _CRT_NONSTDC_NO_WARNINGS
#endif
...
#if !defined(UNALIGNED) && !defined(_NOUNALIGNED_)
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_CGETS(_ReturnType, _DeclSpec, _FuncName, _DstType, _Dst) \
    ...
    template <typename _T> \
    inline \
    _XBOX_CRT_UNSUPPORTED_INSECURE(_FuncName, _FuncName##_s) \
    _ReturnType __CRTDECL _FuncName(_T &_Dst) \
    { \
        return __insecure_##_FuncName(static_cast<_DstType *>(_Dst)); \
    } \
    ...
    template <size_t _Size> \
    inline \
    _XBOX_CRT_UNSUPPORTED(_FuncName) \
    _ReturnType __CRTDECL _FuncName(_DstType (&_Dst)[_Size]) \
    { \
        size_t _SizeRead = 0; \
...
#define __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_CGETS(_ReturnType, _DeclSpec, _FuncName, _DstType, _Dst) \
    _XBOX_CRT_UNSUPPORTED_INSECURE(_FuncName, _FuncName##_s) _DeclSpec _ReturnType __cdecl _FuncName(_DstType *_Dst);
