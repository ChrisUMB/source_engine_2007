...
#ifndef _XBSTRICT
_XBOX_CRT_UNSUPPORTED(_locking)
...
#ifndef _XBSTRICT
_XBOX_CRT_UNSUPPORTED_NONSTDC(locking, _locking)
_CRTIMP __checkReturn int __cdecl locking(__in int _FileHandle, __in int _LockMode, __in long _NumOfBytes);
#endif // XBSTRICT
