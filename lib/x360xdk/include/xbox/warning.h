...
#ifdef DISABLE_VCTOOLS_WARNINGS

#pragma warning(disable:4053)  // one void operand for '?:' (happens for ASSERT(UNREACHED))
#pragma warning(disable:4057)  // function return differs to slight different base...
#pragma warning(disable:4100)  // unreferenced formal parameter
#pragma warning(disable:4115)  // type in parentheses
...
#pragma warning(disable:4206)  // nonstandard extension
#pragma warning(disable:4210)  // nonstandard extension
#pragma warning(disable:4213)  // nonstandard extension
...
#pragma warning(disable:4505)  // unreference local function removed
#pragma warning(disable:4701)  // local variable may be used without initialization
