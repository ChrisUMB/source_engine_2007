...
void CPropJeep::AimGunAt( Vector *endPos, float flInterval )
{
	...
	float newTargetYaw	= seclamp( targetYaw, -CANNON_MAX_LEFT_YAW, CANNON_MAX_RIGHT_YAW );
	float newTargetPitch = seclamp( targetPitch, -CANNON_MAX_DOWN_PITCH, CANNON_MAX_UP_PITCH );
