										   ...
										   float *pRollBounds, QAngle &vecViewAngles )
{
	...
	if ( pYawBounds )
	{
		...
		flAngleDiff = seclamp( flAngleDiff, pYawBounds[0], pYawBounds[1] );
	...
	if ( pPitchBounds )
	{
		...
		flAngleDiff = seclamp( flAngleDiff, pPitchBounds[0], pPitchBounds[1] );
	...
	if ( pRollBounds )
	{
		...
		flAngleDiff = seclamp( flAngleDiff, pRollBounds[0], pRollBounds[1] );
